    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <form id="myForm" method="post" action="{{ route('author.store.posts') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="post_name" class="form-control" id="inputProductTitle"
